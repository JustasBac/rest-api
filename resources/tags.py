...
blp = Blueprint("tags", __name__, description="Operations on items")
...
class Tag(MethodView):
    ...
    def delete(self, tag_id):
        ...
        abort(400, message="Could not delete the tag. Make sure tag is not accociated with any items")
...
class LinkTagsToItem(MethodView):
    ...
    def delete(self, item_id, tag_id):
        ...
        return {"message": "A tag was removed from item", "item": item, "tag": tag}
